...
class Agent:
    ...
    def receive_message(self, neighbor_id, neighbor_choice, message_kind):  # Message arrived by communication network
    ...
    def send_choice_message(self):  # Send message to all the agents with the current choice by communication network
    ...
    def update_next_iteration_choices(self):    # The communication network inform that iteration ends - update choices
        for neighbor, neighbor_info in self.neighbors.items():
